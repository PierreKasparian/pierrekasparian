...
const VALUE_ICONS = [ShieldCheck, BookOpen, Zap];
            ...
            <div className="flex flex-col gap-10">
              {dict.about.parcourItems.map((item) => (
                <div key={item.title} className="relative">
                  <div className="absolute -left-[25px] top-1 size-3 rounded-full border-2 border-[var(--primary)] bg-[var(--background)]" />
      ...
      <section className="border-b border-[var(--border)]">
        <div className="mx-auto max-w-6xl px-6 py-20">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {dict.about.valuesItems.map((item, i) => {

...
export const projects: Project[] = [
  {
    ...
    tags: ["Python", "Langfuse", "LLM", "Prompt Eval"],
    icon: "Sparkles",
    date: "2025-08-01",
    featured: false,
  },
  ...
  },
  {
    ...
    tags: ["Python", "OpenAI", "Anthropic", "Mistral", "LLM"],
    icon: "Zap",
    date: "2025-12-01",
    featured: false,
  },
  {
    ...
    tags: ["Python", "ETL", "LLM"],
    imagePrincipale: "/avis-pretto-2.webp",
    icon: "Mail",
    date: "2026-01-01",
  ...
  },
  {
    ...
    icon: "Compass",
    imagePrincipale: "/Capture d’écran du 2026-05-27 08-59-36.png",
    date: "2025-05-01",
  ...
  },
  {
    ...
    icon: "Code2",
    imagePrincipale: "/Capture d’écran du 2026-05-27 09-01-21.png",
    date: "2025-03-01",
  ...
  },
  {
    ...
    tags: ["Python", "ML", "SVM", "Random Forest", "Mistral"],
    imagePrincipale: "/medee.png",
    icon: "Brain",
    featured: true,
    date: "2024-09-01",
  },
  {
    ...
    imagePrincipale: "/Capture d’écran du 2026-05-07 09-51-35.png",
    images: ["/Capture d’écran du 2026-05-06 17-15-52.png"],
    tags: ["Next.js", "Python", "Redis", "Stripe", "Supabase"],
    icon: "Rocket",
    date: "2026-01-01",
  ...
  },
  {
    ...
    descriptionLong: {
      fr: "Ce site présente une collection de reportages réalisés par le photographe, une galerie de photos à vendre et une newsletter pour notifier les utilisateurs des nouveaux reportages.\n\nUne partie réservée au photographe permet de publier et gérer ses reportages.",
      en: "This website features a collection of reportages created by the photographer, a gallery of photos available for purchase, and a newsletter for users to get notified when new reportages are released.\n\nAdditionally, there's a dedicated section for the photographer, with a login page, where he can easily upload and manage his own reportages.",
    },
    imagePrincipale: "/landing_site_photo.jpg",
    images: ["/reportage.jpg", "/tirages_en_vente.jpg"],
    tags: ["Next.js", "Cloudflare Workers", "Gallery"],
    icon: "Search",
    date: "2023-01-01",
  ...
  },
  {
    ...
    descriptionLong: {
      fr: "Cet algorithme, appelé minimax, analyse les meilleurs coups possibles et leur attribue un score. Un échec et mat reçoit le score maximal.\n\nIl évalue en parallèle les meilleurs coups futurs de l'adversaire et soustrait le score selon ses gains potentiels, sur trois coups d'avance.\n\nIl maximise la valeur des pièces gagnées et minimise celles perdues.",
      en: "This algorithm, called minimax, analyzes all the best possible moves and ranks them with a score. A checkmate is assigned the highest possible score.\n\nAt the same time, it evaluates the opponent's future best possible moves and subtracts the score based on the opponent's potential gains.\n\nThe algorithm then selects the move that results in the highest score after considering both players' best options, looking ahead three moves in advance.",
    },
  ...
  },
  {
    ...
    descriptionLong: {
      fr: "J'ai développé une application Flutter qui intègre GPT-4 avec des prompts et paramètres optimisés pour générer des conseils utiles à partir d'une photo d'exercice.\n\nContrairement à beaucoup d'apps du marché, l'objectif n'était pas de donner la réponse mais de guider l'élève vers une résolution autonome.\n\nTestée avec des élèves, améliorée grâce à leurs retours, puis présentée à un concours d'entrepreneuriat où elle a été primée.",
      en: "I built a Flutter app integrating GPT-4 with optimised prompts and parameters to generate helpful advice for solving exercises from a picture.\n\nUnlike many other apps, my goal was not to provide the answer but to guide students toward solving the problem on their own.\n\nI tested with several students, iterated on feedback, and won an entrepreneurship prize for the work.",
    },
  ...
  },
  {
    ...
    descriptionLong: {
      fr: "Conception et développement d'une version Java du jeu de plateau Pocket Imperium.\n\nTrois joueurs supportés, dont des IA aux stratégies paramétrables. Projet structuré en deux phases : modélisation initiale et développement du jeu (CLI puis interface graphique).\n\nFocus sur modularité, extensibilité et patterns de conception.",
      en: "Design and development of a Java version of the board game Pocket Imperium.\n\nSupports three players including configurable virtual players. Structured in two phases: initial modelling, then development with CLI or GUI.\n\nFocus on modularity, extensibility and design patterns.",
    },
    imagePrincipale: "/java_project.PNG",
    images: ["/fenetre_java.PNG"],
    tags: ["Java", "OOP", "UML", "Swing"],
    icon: "Code2",
    date: "2024-01-01",
  ...
  },
  {
    ...
    descriptionLong: {
      fr: "Modèle de régression linéaire pour prévoir les cours boursiers à partir de données historiques (open, high, low, volume, moyennes mobiles 5/365j).\n\nEntraînement jusqu'à 2013, test au-delà. Étapes clés : preprocessing, feature engineering, entraînement, évaluation MAE/MAPE.\n\nInterface Gradio interactive. Étude de corrélations et features dérivées (écart-type, moyenne de clôture 5j) pour améliorer la robustesse.",
      en: "Linear Regression model to forecast stock prices from historical data (open, high, low, volume, 5/365-day moving averages).\n\nTrained up to 2013, tested beyond. Steps: preprocessing, feature engineering, training, MAE/MAPE evaluation.\n\nInteractive Gradio UI. Correlation studies and engineered features (5-day std and mean close) improved accuracy.",
    },
    imagePrincipale: "/stock_prediction_project.jpg",
    images: ["/correlation.png"],
    tags: ["Python", "scikit-learn", "Gradio", "ML"],
    icon: "Brain",
    date: "2025-01-01",
  },
];

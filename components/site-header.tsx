  ...
  return (
    <header className="sticky top-0 z-40 border-b border-[var(--border)] bg-[var(--background)]/80 backdrop-blur">
      <div className="mx-auto flex h-[4.5rem] max-w-6xl items-center justify-between px-6">
        ...
        >
          <span className="font-semibold tracking-tight text-[var(--primary)]">
            Pierre Kasparian
          </span>
          <span className="inline-flex w-fit items-center rounded-full bg-[var(--accent-strong)]/15 px-2 py-0.5 text-[10px] font-medium text-[var(--primary)]">
            AI &amp; Data freelancer
          </span>
        </Link>
